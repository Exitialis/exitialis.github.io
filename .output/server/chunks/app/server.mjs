...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderComponent, ssrRenderAttr, ssrRenderClass, ssrRenderStyle, ssrRenderSlot, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const resource$1 = {
  ...
  "lastName": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Neshchadin"]);
  },
  "firstName": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Ivan Pavlovich"]);
  },
  "pageTitles": {
    "about": (ctx) => {
      const { normalize: _normalize } = ctx;
...
const resource = {
  ...
  "goodbye": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["До свидания"]);
  },
  "lastName": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Нещадин"]);
  },
  "firstName": (ctx) => {
    const { normalize: _normalize } = ctx;
    return _normalize(["Иван Павлович"]);
  },
  "pageTitles": {
    "about": (ctx) => {
      const { normalize: _normalize } = ctx;
    ...
    "resume": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Резюме"]);
    },
    "portfolio": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Портфолио"]);
    },
    "blog": (ctx) => {
      const { normalize: _normalize } = ctx;
  ...
  "about": {
    "skills": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Скиллы"]);
    },
    "description": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Senior Engineer в Авито, профессионально разрабатываю с 2015 года, начинал разрабатывать на PHP, затем, в 2019 году перешел на разработку на языке Go. Работал в нескольких небольших стартапах, а также в двух крупных компаниях - CarPrice и сейчас работаю в Авито. Увлекаюсь разработкой - это действительно мое хобби, также интересуюсь разными моделями клавиатур, самостоятельно спаял и собрал две клавиатуры, использую ортогональные сплит клавиатуры. Печатаю десятипальцевым методом, играю на гитаре (окончил музыкальную школу), много играю в компьютерные игры. Увлекаюсь тренажерным залом и много путешествую."]);
    }
  }
};
const messages = { "en": resource$1, "ru_RU": resource };
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-screen w-full flex items-center justify-center" }, _attrs))} data-v-33026159><h2 class="animate" data-v-33026159><img${ssrRenderAttr("src", _imports_0$2)} class="w-40" data-v-33026159></h2></div>`);
}
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-33026159"]]);
...
const LangSwitcher2_vue_vue_type_style_index_0_scoped_96b97214_lang$1 = ".p-dropdown[data-v-96b97214]{border:none!important}";
const Navbar_vue_vue_type_style_index_0_scoped_29a456f6_lang$1 = "a.router-link-active[data-v-29a456f6]{font-weight:700}a.router-link-exact-active[data-v-29a456f6]{color:var(--vegas-gold)}";
...
const __default__ = {
  ...
  methods: {
    ...
    getRepos() {
      axios.get("https://api.github.com/users/exitialis/repos").then((res) => {
...
const _sfc_main$c = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<li${ssrRenderAttrs(mergeProps({ class: "about-item" }, _attrs))}><div class="about-content-box"><p class="about-item-text">${ssrInterpolate(_ctx.$t("about.description"))}</p></div></li>`);
    };
  }
};
...
const _sfc_main$b = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.skill.image !== null && __props.skill.icon !== "") {
        _push(`<img${ssrRenderAttr("src", __props.skill.image)} alt="mobile app icon" class="w-40">`);
      } else {
        _push(ssrRenderComponent(unref(Icon), {
          icon: __props.skill.icon,
          class: "text-ranko-500 text-[3rem] mx-auto",
          style: { "width": "40px" }
        }, null, _parent));
      }
      _push(`</div><div class="service-content-box"><h4 class="h4 service-item-title">${ssrInterpolate(__props.skill.title)}</h4><p class="service-item-text">${ssrInterpolate(unref(description))}</p></div></li>`);
    };
  }
};
...
const _sfc_main$a = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Skill = __nuxt_component_1$2;
      _push(`<article${ssrRenderAttrs(mergeProps({
        class: "about active",
        "data-page": "about"
      ...
      _push(`</ul></section><div class="separator"></div><section class="service"><br><h3 class="h3 pb-5">${ssrInterpolate(_ctx.$t("about.skills"))}</h3><ul class="service-list"><!--[-->`);
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(categories), (category) => {
        _push(`<li class="filter-item"><button class="${ssrRenderClass({ active: unref(activeCategory) === category.id })}">${ssrInterpolate(_ctx.$t("category.title"))}</button></li>`);
      });
      _push(`<!--]--></ul><div class="filter-select-box"><button class="${ssrRenderClass([{ active: unref(filterMenu) }, "filter-select"])}"><div class="select-value">${ssrInterpolate(unref(activeCategory) !== 0 ? unref(locale) === "en" ? (_a = unref(activeCategoryName)) == null ? void 0 : _a.en : (_b = unref(activeCategoryName)) == null ? void 0 : _b.ru_RU : "Select Category")}</div><div class="select-icon"><ion-icon name="chevron-down"></ion-icon></div></button><ul class="select-list"><li class="select-item"><button> All </button></li><!--[-->`);
      ssrRenderList(unref(categories), (category) => {
        var _a2, _b2;
        _push(`<li class="select-item"><button>${ssrInterpolate(unref(locale) === "en" ? (_a2 = category.title) == null ? void 0 : _a2.en : (_b2 = category.title) == null ? void 0 : _b2.ru_RU)}</button></li>`);
      });
      ...
      _push(`<span>${ssrInterpolate(unref(locale) === "en" ? (_d = (_c = unref(activeItem).category) == null ? void 0 : _c.date) == null ? void 0 : _d.en : (_f = (_e = unref(activeItem).category) == null ? void 0 : _e.date) == null ? void 0 : _f.ru_RU)}</span> | `);
      _push(ssrRenderComponent(unref(Icon), { icon: "dashicons:category" }, null, _parent));
      _push(`<span>${ssrInterpolate(unref(locale) === "en" ? (_h = (_g = unref(activeItem).category) == null ? void 0 : _g.title) == null ? void 0 : _h.en : (_j = (_i = unref(activeItem).category) == null ? void 0 : _i.title) == null ? void 0 : _j.ru_RU)}</span> | `);
      _push(ssrRenderComponent(unref(Icon), { icon: "ri:search-eye-line" }, null, _parent));
      _push(`<a${ssrRenderAttr("href", unref(activeItem).url)} target="_blank">${ssrInterpolate(unref(locale) === "en" ? (_k = unref(activeItem).desc) == null ? void 0 : _k.en : (_l = unref(activeItem).desc) == null ? void 0 : _l.ru_RU)}</a></small><p class="text-justify">${unref(locale) === "en" ? (_m = unref(activeItem).content) == null ? void 0 : _m.en : (_n = unref(activeItem).content) == null ? void 0 : _n.ru_RU}</p></div></section></div></section></article>`);
    };
  }
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<article${ssrRenderAttrs(mergeProps({
        class: "resume active",
        "data-page": "resume"
      }, _attrs))}><header><h2 class="h2 article-title">${ssrInterpolate(_ctx.$t("pageTitles.resume"))}</h2></header><section class="timeline"><ol class="timeline-list"><li class="timeline-item"><h4 class="h4 timeline-item-title"> Company </h4><span>From — Until</span><p class="timeline-item-desc"> Location </p><p class="timeline-text"></p></li><li class="timeline-item"><h4 class="h4 timeline-item-title"> Simex inc. </h4><span>10.2016 - 11.2017</span><p class="timeline-item-desc"> Moscow </p><p class="timeline-text"> Junior Fullstack Developer </p></li></ol></section><section class="skill"><ul class="skills-list content-card"><li class="skills-item"><div class="title-wrapper"><h5 class="h5"> Your Skill </h5><data value="90">90%</data></div><div class="skill-progress-bg"><div class="skill-progress-fill" style="${ssrRenderStyle({ "width": "90%" })}"></div></div></li></ul></section></article>`);
    };
  }
};
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    useLocaleStore();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "cursor-pointer transition-all fade" }, _attrs))} data-v-96b97214><img${ssrRenderAttr("src", `/flags/${unref(locale)}.png`)} class="h-6" data-v-96b97214></div>`);
    };
  }
};
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-96b97214"]]);
const _imports_0 = "" + __publicAssetsURL("images/avatar.jpg");
const _sfc_main$6 = {
  __name: "Sidebar",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="sidebar-info"><figure class="avatar-box"><img${ssrRenderAttr("src", _imports_0)} alt="Photo" width="80" height="100"></figure><div class="info-content"><h1 class="name" title="Neshchadin Ivan Pavlovich">${ssrInterpolate(_ctx.$t("lastName"))} <br> ${ssrInterpolate(_ctx.$t("firstName"))}</h1><p class="title text-center xl:block flex items-center justify-center gap-1"><span class="xl:after:content-[&#39;&#39;] after:content-[&#39;,&#39;]">Software Architect</span><span>Backend Engineer</span></p></div><button class="info_more-btn"><span>Show Contacts</span><ion-icon name="chevron-down"></ion-icon></button></div><div class="sidebar-info_more"><div class="separator"></div><ul class="contacts-list"><li class="contact-item"><div class="icon-box">`);
      _push(ssrRenderComponent(unref(Icon), { icon: "simple-icons:habr" }, null, _parent));
      _push(`</div><div class="contact-info"><p class="contact-title"> Habr </p><a href="https://habr.com/en/users/exitialis" class="contact-link" target="_blank">exitialis</a></div></li><li class="contact-item"><div class="icon-box"><ion-icon name="logo-github"></ion-icon></div><div class="contact-info"><p class="contact-title"> Github </p><a href="https://github.com/exitialis" class="contact-link" target="_blank">exitialis</a></div></li><li class="contact-item"><div class="icon-box"><ion-icon name="logo-linkedin"></ion-icon></div><div class="contact-info"><p class="contact-title"> Linkedin </p><a href="https://id.linkedin.com/in/exitialis" class="contact-link" target="_blank">exitialis</a></div></li><li class="contact-item"><div class="icon-box"><ion-icon name="location-outline"></ion-icon></div><div class="contact-info"><p class="contact-title"> Location </p><address>Moscow, Russia</address></div></li></ul><div class="separator"></div><ul class="social-list"><li class="social-item">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "mailto:lpexitialis@gmail.com",
        class: "social-link",
        target: "_blank"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$3;
  _push(`<nav${ssrRenderAttrs(mergeProps({ class: "navbar" }, _attrs))} data-v-29a456f6><ul class="navbar-list" data-v-29a456f6><li class="navbar-item" data-v-29a456f6>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "navbar-link"
  }, {
  ...
  _push(`</li><li class="navbar-item" data-v-29a456f6>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/resume",
    class: "navbar-link"
  }, {
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-29a456f6"]]);
  ...
  setup(__props) {
    ...
    useHead({
      ...
      titleTemplate: (pageTitle) => {
        return pageTitle ? `${pageTitle} - Neshchadin Ivan ` : "Neshchadin Ivan";
      },
      meta: [
        { charset: "utf-8" },
...
export { CookieBar_vue_vue_type_style_index_0_scoped_1144c8c8_lang$1 as C, LoadingPage_vue_vue_type_style_index_0_scoped_33026159_lang as L, Navbar_vue_vue_type_style_index_0_scoped_29a456f6_lang$1 as N, app_vue_vue_type_style_index_0_lang as a, error404_vue_vue_type_style_index_0_scoped_30d2164e_lang$1 as b, LangSwitcher2_vue_vue_type_style_index_0_scoped_96b97214_lang$1 as c, entry$1 as default, error500_vue_vue_type_style_index_0_scoped_32388612_lang$1 as e, flicking$1 as f, style as s, tailwind as t };
