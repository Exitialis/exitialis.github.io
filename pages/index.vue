        ...
        <li v-for="testimonial in testimonials" :key="testimonial.id" class="testimonials-item" @click="showTestimonial(testimonial.id)">
          <div class="content-card">
            ...
            <div class="testimonials-text">
              <p>{{ locale === 'en' ? testimonial.content?.en : testimonial.content?.ru_RU }}</p>
            </div>
          </div>
        </li>
      </ul>
    ...
    <div class="modal-container" :class="{ active: activeModal }">
      ...
      <section class="testimonials-modal">
        ...
        <div class="flex gap-5 items-start">
          ...
          <p class="text-justify text-gray-400 text-sm md:text-md" v-html="locale === 'en' ? testimonialItem.content?.en : testimonialItem.content?.ru_RU" />
        </div>
